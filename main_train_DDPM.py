...
pre_trained_model = None# '/mnt/camca_NAS/diffusion_ct_motion/models/portable_DDPM_patch_3Dmotion_hist_trial/models/model-1.pt'# or path of the pre-trained model
