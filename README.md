...
- **Paired data and Simulation**<br />
    - you want to have paired motion-free and motion-corrupted image (generated by FBP) for training purpose. If you need to simulate motion-corrupted image, please use ```motion_simulation/portable_CT_motion_simulator``` and remember to cite [Chen et al.](https://aapm.onlinelibrary.wiley.com/doi/abs/10.1002/mp.17047). Note that the simulation were done on the static image with pixel size = [1,1,1]mm (so that we have enough z information) and then resample to [1,1,2.5]mm. <br />
