...
- **Paired data and Simulation**<br />
    - you want to have paired motion-free and motion-corrupted image (generated by FBP) for training purpose. If you need to simulate motion-corrupted image, please use ```motion_simulation/portable_CT_motion_simulator.py``` <br />
