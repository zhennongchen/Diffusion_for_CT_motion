...
########################### set the data path!
data_sheet = os.path.join(cg.diffusion_dir,'data/Patient_list/Patient_list_real_portable_CT_202404_resample_avg.xlsx')
...
# some dummy code
slice_range_list_for_50 = [[0,20],[10,30],[20,40],[30,50]]
